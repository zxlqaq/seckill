...
import com.zxl.seckill.feign.ProductFacadeService;
import com.zxl.seckill.model.ActivityDescDTO;
import com.zxl.seckill.model.ProductDescDTO;
import com.zxl.seckill.model.ProductDetailDTO;
...
public class MockController {
    ...
    private final ProductFacadeService productExportService;
...
//    RedisTools redisTools;
    ...
    public String createActivity(SeckillActivityDTO activityDTO) {
        try{
            ...
            if(ResultCodeConstant.SUCCESS.equals(result.getCode())){
                return "创建活动成功!";
            }else{
