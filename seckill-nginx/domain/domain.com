server {
        ...
        #用户ID
        set_by_lua_file $user_id /Users/zxl/Documents/demo/seckill/seckill-nginx/lua/set_common_var.lua;

        #活动数据查询
        location /activity/query{
            limit_req zone=limit_by_user nodelay;
            content_by_lua_file /Users/zxl/Documents/demo/seckill/seckill-nginx/lua/activity_query.lua;
        ...
        location /settlement/submitData{
            access_by_lua_file /Users/zxl/Documents/demo/seckill/seckill-nginx/lua/submit_access.lua;
            proxy_pass http://backend;
            error_page 500 502 503 504 @json_fail;
        }
        ...
        include /Users/zxl/Documents/demo/seckill/seckill-nginx/domain/public.com;
